...
BMI (Body Mass Index) is a measure of body fat based on height and weight. It is measured using the standard formula of __*$weight(kg) / height^{2}(m^{2})$*__. For instance, a person with height of __*1.8m*__ and weight of __*75kg*__ would have a BMI of __*`r round(75/(1.8^2),1)`*__.
